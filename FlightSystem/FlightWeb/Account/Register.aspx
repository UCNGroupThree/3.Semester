<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Register.aspx.cs" Inherits="FlightWeb.Account.Register" %>
    ...
    <div class="form-horizontal">
        ...
        <asp:ValidationSummary runat="server" CssClass="text-danger" />
           <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="Name" CssClass="form-control" TextMode="Email" />
           ...
           <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="Address" CssClass="form-control" TextMode="Email" />
           ...
           <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="City" CssClass="form-control" TextMode="Email" />
           ...
           <div class="form-group">
            ...
            <div class="col-md-10">
                <asp:TextBox runat="server" ID="Postal" CssClass="form-control" TextMode="Email" />
